    ...
    <el-row>
      <el-col class="Oinn" :span="24">
        ...
        <el-table-column label="日期" >
            <template slot-scope="scope">{{ scope.row.inYearMonth }}</template>
          </el-table-column>
      <el-table-column label="宿舍栋号" >
          ...
          <el-table-column prop="avgScore" label="宿舍卫生平均总得分"></el-table-column>
        </el-table>
      </el-col>
    </el-row>
    <!-- 修改 -->
...
moment
  ...
  methods: {
    handleSizeChange(val) {
      ...
      this.axios({
        method: "get",
        url: `http://122.112.253.28:8095/prod-api/report/hygienestatistics/list?pageNum=1&pageSize=${val}`,
        headers: {
          Authorization: window.sessionStorage.token
        }
      }).then(relt => {
    ...
    handleCurrentChange(val) {
      ...
      this.axios({
        method: "get",
        url: `http://122.112.253.28:8095/prod-api/report/hygienestatistics/list?pageNum=${val}&pageSize=10`,
        headers: {
          Authorization: window.sessionStorage.token
        }
      }).then(relt => {
    ...
    onSubmit() {
      ...
      this.axios({
        method: "get",
        url:
          "http://122.112.253.28:8095/prod-api/report/hygienestatistics/list?pageNum=1&pageSize=10&inYearMonth=" +
          this.formInline.user,
        headers: {
          Authorization: window.sessionStorage.token
        }
    ...
    del(index, id) {
      this.axios({
        method: "DELETE",
        url:
          "http://122.112.253.28:8095/prod-api/report/hygienestatistics/deleteByIds/" +
          id,
        headers: {
          Authorization: window.sessionStorage.token
        }
    ...
    Xiu(id) {
      ...
      this.axios({
        method: "GET",
        url: " http://122.112.253.28:8095/prod-api/report/hygienestatistics/" + id,
        headers: {
          Authorization: window.sessionStorage.token
        }
      }).then(relt => {
    ...
    Xiugai() {
      this.axios({
        method: "PUT",
        url:
          "http://122.112.253.28:8095/prod-api/report/hygienestatistics/update/" +
          this.idd,
        headers: {
          Authorization: window.sessionStorage.token
        },
