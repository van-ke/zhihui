  ...
  <div id="Bclass">
    ...
    <el-dialog title="修改班级信息" :visible.sync="dialogVisible2" width="width: 41%">
      ...
      >
        ...
        <el-form-item label="设备IP地址" prop="age" disabled>
          <el-input type="text" :placeholder="Cxun2.dormitoryNo" disabled autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="识别成功提示语" prop="age" disabled>
          <el-input type="text" :placeholder="Cxun2.dormitoryNo" disabled autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="设备号" prop="age" disabled>
          <el-input type="text" :placeholder="Cxun2.dormitoryNo" disabled autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="设备名称" prop="age" disabled>
          <el-input type="text" :placeholder="Cxun2.dormitoryNo" disabled autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="图片质量" prop="age" disabled>
          <el-input type="text" :placeholder="Cxun2.dormitoryNo" disabled autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="识别成功后开门">
          <el-select disabled v-model="Cxun2.storey ">
            <el-option
              v-for="(item, index) in dq2"
              :key="index"
        ...
        <el-form-item label="身份证比对阈值" prop="age" disabled>
          <el-input type="text" :placeholder="Cxun2.dormitoryNo" disabled autocomplete="off"></el-input>
        </el-form-item>

        <el-form-item label="识别成功后开门持续时间" prop="age" disabled>
          <el-input type="text" :placeholder="Cxun2.dormitoryNo" disabled autocomplete="off"></el-input>
        </el-form-item>

        <el-form-item label="人脸比对阈值" prop="age" disabled>
          <el-input type="text" :placeholder="Cxun2.dormitoryNo" disabled autocomplete="off"></el-input>
        </el-form-item>

        <el-form-item label="设备声音大小" prop="age" disabled>
          <el-input type="text" :placeholder="Cxun2.dormitoryNo" disabled autocomplete="off"></el-input>
        </el-form-item>

        <el-form-item label="人脸对比后等待时间" prop="age" disabled>
          <el-input type="text" :placeholder="Cxun2.dormitoryNo" disabled autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
  ...
  methods: {
    onSubmit() {
      this.axios({
        method: "get",
        url:
          "http://122.112.253.28:8095/prod-api/smartdor/sddevice/list?pageNum=1&pageSize=10&buildingNo=" +
    ...
    del(index, id) {
      this.axios({
        method: "DELETE",
        url:
          "http://122.112.253.28:8095/prod-api/smartdor/sddevice/deleteByIds/" +
          id,
        headers: {
          Authorization: window.sessionStorage.token
        }
    ...
    Xiu(id) {
      ...
      this.axios({
        method: "GET",
        url: " http://122.112.253.28:8095/prod-api/smartdor/sddevice/" + id,
        headers: {
          Authorization: window.sessionStorage.token
        }
      }).then(relt => {
